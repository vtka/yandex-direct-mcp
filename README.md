...
После создания OAuth-приложения необходимо подать заявку на доступ к API Яндекс Директа:

1. Войдите в [Яндекс Директ](https://direct.yandex.ru/)
2. Перейдите в **Информация → API** (или по прямой ссылке: `https://direct.yandex.ru/registered/main.pl?cmd=apiSettings`)
3. Заполните заявку, указав Client ID вашего OAuth-приложения
4. Дождитесь подтверждения (обычно автоматически или в течение нескольких часов)

> **Без этого шага API вернёт ошибку «Незавершенная регистрация».**
